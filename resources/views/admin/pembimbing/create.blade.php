    ...
    <div class="col-12">
        <div class="card-soft p-3 d-flex flex-row justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="fw-bold mb-0">Tambah Pembimbing Industri</h5>
                    <small class="text-muted">Masukkan data pembimbing lapangan baru</small>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row g-4 position-relative">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nama" class="form-control border-start-0 p-2" placeholder="Nama Lengkap" value="{{ old('nama') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" name="email" class="form-control border-start-0 p-2" placeholder="Email Pembimbing" value="{{ old('email') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="jabatan" class="form-control border-start-0 p-2" placeholder="Contoh: Senior Developer" value="{{ old('jabatan') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <small class="text-muted mt-1 d-block" style="font-size: 0.7rem;">Pilih divisi yang akan dikelola oleh pembimbing ini.</small>
                    </div>
                    ...
                    <div class="col-12 mt-5">
                        <div class="d-flex justify-content-end gap-3">
                            ...
                            <button type="submit" class="btn btn-primary rounded-pill px-5 fw-bold shadow-sm transition-all hover-up">
                                <i class='bx bx-save me-1'></i> Simpan Pembimbing
                            </button>
                        </div>
                    </div>
                </div>
