    ...
    <div class="col-12">
        <div class="card-soft p-3 d-flex flex-row justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                <a href="{{ route('admin.tugas.index') }}" class="btn btn-outline-secondary btn-sm rounded-circle me-3" style="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center;">
                    <i class='bx bx-left-arrow-alt fs-4'></i>
                </a>
                <div>
                    <h5 class="fw-bold mb-0">Hasil Pengumpulan Tugas</h5>
                    ...
                    <div class="p-3 rounded-4 border border-primary border-opacity-10 transition-all hover-light" style="background-color: #f8fafc;">
                        <div class="d-flex align-items-center gap-3 mb-3">
                            ...
                            <div class="overflow-hidden">
                                <div class="fw-bold text-dark small text-truncate" style="max-width: 100%;">{{ basename($tugas->file) }}</div>
                                <small class="text-muted d-block" style="font-size: 0.7rem;">Klik tombol untuk melihat file</small>
                            </div>
                        </div>
                        <a href="{{ asset('storage/'.$tugas->file) }}" target="_blank" class="btn btn-primary btn-sm rounded-pill w-100 fw-bold py-2 shadow-sm">
                        ...
                        <div class="list-group-item px-0 py-3 border-bottom border-light">
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col-12 col-md-4 text-md-end">
                                    @if($pengumpulan && ($pengumpulan->file || $pengumpulan->link))
                                        <a href="{{ $pengumpulan->file ? asset('storage/'.$pengumpulan->file) : $pengumpulan->link }}" target="_blank" class="btn btn-outline-primary btn-sm rounded-pill px-4 py-2 fw-bold w-100 w-md-auto shadow-sm transition-all hover-up">
