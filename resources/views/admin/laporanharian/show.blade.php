    ...
    <div class="col-12">
        <div class="card-soft p-3 d-flex flex-row justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                <a href="{{ route('admin.laporanharian.index') }}" class="btn btn-outline-secondary btn-sm rounded-circle me-3" style="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center;">
...
<div class="row g-4">
    ...
    <div class="col-lg-8">
        ...
        <!-- VERIFICATION FORM (Only if needed) -->
        ...
        <div class="card-soft p-4 h-100 shadow-sm border-0 overflow-hidden">
            ...
            <div class="timeline-modern">
                ...
                <div class="text-center py-5">
                    <div class="icon-circle bg-light text-muted mx-auto mb-3" style="width: 50px; height: 50px;"><i class='bx bx-info-circle'></i></div>
...
.preview-content { max-width: 800px; width: 100%; background: white; }
</style>
