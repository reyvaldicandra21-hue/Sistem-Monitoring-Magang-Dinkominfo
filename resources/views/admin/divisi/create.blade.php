    ...
    <div class="col-12">
        <div class="card-soft p-3 d-flex flex-row justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="fw-bold mb-0">Tambah Divisi Baru</h5>
                    <small class="text-muted">Masukkan unit kerja atau departemen baru</small>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row g-4 position-relative">
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nama_divisi" class="form-control border-start-0 p-3 fw-bold text-dark" placeholder="Contoh: Divisi IT / Produksi" value="{{ old('nama_divisi') }}" required>
                        </div>
                        <small class="text-muted mt-2 d-block" style="font-size: 0.75rem;">Pastikan nama divisi unik dan mudah diidentifikasi.</small>
                    </div>
                    ...
                    <div class="col-12 mt-5">
                        <div class="d-flex justify-content-end gap-3">
                            ...
                            <button type="submit" class="btn btn-primary rounded-pill px-5 fw-bold shadow-sm transition-all hover-up">
                                <i class='bx bx-save me-1'></i> Simpan Divisi
                            </button>
                        </div>
                    </div>
                </div>
